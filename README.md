...
眠れない夜に、ひつじや素数をゆっくり数えたりするための、小さなリラクゼーションWebアプリです。

このリポジトリは、**ひつじの夜庭 Web版** のソースコードを管理しています。
スマートフォンやPCのブラウザから利用でき、AndroidではChromeからホーム画面に追加してアプリのように使うこともできます。

## リンク
- [ひつじの夜庭 Web版](https://kako-n0.github.io/sheep-night-garden-web/)
- [プライバシーポリシー](https://kako-n0.github.io/sheep-night-garden-web/privacy_policy.html)
